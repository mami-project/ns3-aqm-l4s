...
#ifndef L4S_PI2_QUEUE_DISC_H
#define L4S_PI2_QUEUE_DISC_H
 ...
 */
class L4SPi2QueueDisc : public QueueDisc
{
public:
  /**
  ...
  /**
   * \brief L4SPi2QueueDisc Constructor
   */
  L4SPi2QueueDisc ();

  /**
   * \brief L4SPi2QueueDisc Destructor
   */
  virtual ~L4SPi2QueueDisc ();
...
private:
  ...
  Time m_tShift;
  double m_dropProbL4SMax;
  double m_dropProbClassicMax;
