...
#ifndef L4S_CRED_QUEUE_DISC_H
#define L4S_CRED_QUEUE_DISC_H
 ...
 */
class L4SCREDQueueDisc : public QueueDisc
{
public:
  /**
  ...
  /**
   * \brief L4SCREDQueueDisc Constructor
   */
  L4SCREDQueueDisc ();

  /**
   * \brief L4SCREDQueueDisc Destructor
   */
  virtual ~L4SCREDQueueDisc ();
...
private:
  ...
  double m_dropScaleL4S;
  double m_dropScaleClassic;
  double m_wQDelayAvg;
