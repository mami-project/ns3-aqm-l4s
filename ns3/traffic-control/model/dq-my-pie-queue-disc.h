...
#ifndef DQ_MY_PIE_QUEUE_DISC_H
#define DQ_MY_PIE_QUEUE_DISC_H
 ...
 */
class DQMyPieQueueDisc : public QueueDisc
{
public:
  /**
  ...
  /**
   * \brief DQMyPieQueueDisc Constructor
   */
  DQMyPieQueueDisc ();

  /**
   * \brief DQMyPieQueueDisc Destructor
   */
  virtual ~DQMyPieQueueDisc ();
...
private:
  ...
  Time m_tUpdateL4S;                               //!< Time period after which CalculateP () is called
  Time m_tUpdateClassic;
  ...
  EventId m_rtrsEventL4S;                          //!< Event used to decide the decision of interval of drop probability calculation
  EventId m_rtrsEventClassic;
  ...
  std::ofstream m_probabilityFile;
};
